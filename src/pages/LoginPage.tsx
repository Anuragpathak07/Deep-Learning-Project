...
import { ScanLine, Mail, Lock, ArrowRight, Github } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] rounded-full opacity-20 blur-[100px]" style={{ background: "hsl(239 84% 67% / 0.3)" }} />
        <div className="absolute bottom-1/3 right-1/3 w-[400px] h-[400px] rounded-full opacity-15 blur-[100px]" style={{ background: "hsl(199 89% 60% / 0.2)" }} />
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.5 }} className="w-full max-w-md relative z-10">
        <div className="glass-card p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Sign in to your PlateVision account</p>
          </div>
